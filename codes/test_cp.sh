...
python run_mlp.py models/test_bs.json results/acc_bs_new_.txt results/loss_bs_new.txt
python run_mlp.py models/test_long_deep.json results/acc_da_new.txt results/loss_da_new.txt -da
